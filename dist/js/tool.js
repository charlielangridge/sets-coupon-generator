...
Nova.booting(function (Vue, router, store) {
    Vue.component('sets-coupon-generator', __webpack_require__(2));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        runCouponGeneration: function runCouponGeneration() {
            var _this = this;
            ...
            Nova.request().post('/nova-vendor/sets-coupon-generator/generate', {
                ...
                if (response.data['generated'] > 0) {
                    _this.$toasted.show(response.data['generated'] + " Coupons Generated", { type: "success" });
                }
          ...
          _c(
            "button",
            {
              ...
              on: {
                click: function($event) {
                  $event.preventDefault()
                  return _vm.generateCoupons($event)
                }
              }
            },
            [
